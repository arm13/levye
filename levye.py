...
class Levye:
	...
	def __init__(self):
		...
		parser.add_argument('-l', '--log', dest = 'log_file', action = 'store', help = 'Log File', default = "levye.log", type = file)				
                parser.add_argument('-o', '--output', dest = 'output', action = 'store', help = 'Output File', default = "levye.out", type = file)		
